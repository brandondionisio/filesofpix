...
INCLUDES = restoration.h processing.h memory.h
...
restoration: restoration.o readaline.o processing.o memory.o
	$(CC) $(LDFLAGS) -o restoration  restoration.o readaline.o processing.o memory.o  $(LDLIBS)
